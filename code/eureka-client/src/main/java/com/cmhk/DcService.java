...
public class DcService {
    ...
    public String get(String a,String b) {
        ...
        map.put("a","a");
        map.put("b","b");
        String str = restTemplate.getForObject("http://eureka-jar/get?a="+a+"&b="+b, String.class);
        str += restTemplate.getForObject("http://eureka-jar/get?a={a}&b={b}", String.class,map);
    ...
    public String post(Map<String,Object> param){
        ...
        String str = restTemplate.postForObject("http://eureka-jar/post",param,String.class);
        System.out.println("调用接口返回值"+str);
        return str;
    }

    public String fallbackget(String a,String b) {
        return "eureka-client:fallback";
    }
